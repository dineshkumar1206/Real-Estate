    ...
    <div
     ...
     className="flex-shrink-0 w-[280px] sm:w-[300px] md:w-[320px] bg-white cursor-pointer rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1.5 hover:border-blue-500/20 transition-all duration-300 overflow-hidden group">
      ...
      <div className="p-4 space-y-1.5">
        ...
        <p className="font-bold text-[15px] text-[#C0573E]">{project.price}</p>
...
export default function LatestPropertyLaunches() {
  ...
  const projects = listings.filter(p => p.projectType === 'latest-launches');
  ...
  if (projects.length === 0) {
    return null; // Hide this section if there are no launches
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 lg:px-16 flex flex-col gap-6">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <a
              href="#"
              className="hidden sm:flex items-center gap-1 text-black text-sm font-medium hover:underline"
            >
              View all
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        >
          <a
            href="#"
            className="flex items-center gap-1 text-black text-sm font-medium border border-black rounded-full px-5 py-2 hover:bg-gray-100 transition-colors"
          >
            View all projects
