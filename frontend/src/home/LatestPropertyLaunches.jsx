...
import { Heart, Building2, MapPin, Sparkles, ChevronLeft, ChevronRight, Share2 } from 'lucide-react';
      ...
      <div className="relative overflow-hidden h-[200px] sm:h-[210px] bg-slate-900">
        ...
        <div className="absolute top-3 right-3 flex gap-2 z-10">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-md hover:bg-white text-slate-400 hover:text-slate-700 transition-colors cursor-pointer active:scale-90"
          >
            <Share2 size={14} strokeWidth={2.2} />
          </button>
        </div>
        <div className="absolute bottom-3 left-3 z-10">
          <StatusIcon status={project.status || 'Newly Launched'} />
        </div>
